local Translations = {
    ...
    general = {
        ...
        push_stretcher_button = "~g~E~w~ - Duw Brancard",
        stop_pushing_stretcher_button = "~g~E~w~ - Duwen Stoppen",
        lay_stretcher_button = "~g~G~w~ - Lig Op Brancard",
        push_position_drawtext = "Duw Hier",
        get_off_stretcher_button = "~g~G~w~ - Van Brancard Af Gaan",
        get_out_trunk_button = "[~g~E~w] Stap uit de kofferbak",
        close_trunk_button = "[~g~G~w~] Sluit de kofferbak",
        open_trunk_button = "[~g~G~w~] Open de kofferbak",

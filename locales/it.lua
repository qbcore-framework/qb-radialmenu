local Translations = {
    ...
    general = {
        ...
        push_stretcher_button = "~g~E~w~ - Spingi barella",
        stop_pushing_stretcher_button = "~g~E~w~ - Smetti di spingere",
        lay_stretcher_button = "~g~G~w~ - Sdraiati sulla barella",
        push_position_drawtext = "Spingi qui",
        get_off_stretcher_button = "~g~G~w~ - Scendi dalla barella",
        get_out_trunk_button = "[~g~E~w] Esci dal bagagliaio",
        close_trunk_button = "[~g~G~w~] Chiudi il bagagliaio",
        open_trunk_button = "[~g~G~w~] Apri il bagagliaio",

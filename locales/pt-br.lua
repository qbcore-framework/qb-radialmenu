local Translations = {
    error = {
        ...
        race_harness_on = "Você está usando um cinto de corrida, não pode trocar de lugar",
    ...
    info = {
        no_variants = "Parece que não há variantes para isso",
        wrong_ped = "Este modelo de NPC não permite esta opção",
